 ...
 */
@ModMethodPatch(target = HumanMob.ShowMobThoughtMobAbility.class, name = "runAndSend", arguments = {Mob.class, int.class})
public class ShowMobThoughtPatch {
    @Advice.OnMethodExit
    public static void onExit(
        ...
        TicketManager
                ...
                .setDecidedTicket(ability.getMob().getUniqueID(), target.getStringID(), Ticket.Kind.Animal);
    }
